...
{
    public partial class cadCli : System.Windows.Forms.Form
    {
        public cadCli()
        {
            InitializeComponent();
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                banco.cadastrarCliente(txtNome.Text, txtCPF.Text, txtRG.Text, cboSexo.Text, DateTime.Parse(mtxtDtNasc.Text), int.Parse(cboCid.SelectedValue.ToString()),txtDsEnd.Text);
